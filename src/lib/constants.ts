...
export const PRACTICE_SENTENCES = [
  { japanese: "こんにちは、げんきですか？", romaji: "Konnichiwa, genki desu ka?", meaning: "Hello, how are you?" },
  { japanese: "わたしは がくせいです。", romaji: "Watashi wa gakusei desu.", meaning: "I am a student." },
  { japanese: "にほんりょうりが だいすきです。", romaji: "Nihon ryouri ga daisuki desu.", meaning: "I love Japanese food." },
  { japanese: "にほんごを べんきょうしています。", romaji: "Nihongo o benkyou shite imasu.", meaning: "I am studying Japanese." },
  { japanese: "きょうは いいてんきですね。", romaji: "Kyou wa ii tenki desu ne.", meaning: "The weather is nice today, isn't it?" },
  { japanese: "すみません、おみずを ください。", romaji: "Sumimasen, omizu o kudasai.", meaning: "Excuse me, please give me some water." },
  { japanese: "これは いくらですか？", romaji: "Kore wa ikura desu ka?", meaning: "How much is this?" },
  { japanese: "えきは どこに ありますか？", romaji: "Eki wa doko ni arimasu ka?", meaning: "Where is the station?" },
  { japanese: "また あした あいましょう。", romaji: "Mata ashita aimashou.", meaning: "Let's meet again tomorrow." },
  { japanese: "はじめまして、どうぞよろしく。", romaji: "Hajimemashite, douzo yoroshiku.", meaning: "Nice to meet you." },
  ...
  { japanese: "どこから きましたか？", romaji: "Doko kara kimashita ka?", meaning: "Where did you come from?" },
  { japanese: "ちょっと まってください。", romaji: "Chotto matte kudasai.", meaning: "Wait a moment please." },
  { japanese: "おやすみなさい。", romaji: "Oyasumi nasai.", meaning: "Good night." },
  { japanese: "さようなら。", romaji: "Sayounara.", meaning: "Goodbye." },
  { japanese: "おなかが すきました。", romaji: "Onaka ga sukimashita.", meaning: "I am hungry." },
  { japanese: "コーヒーが すきです。", romaji: "Koohii ga suki desu.", meaning: "I like coffee." },
  { japanese: "いっしょに えいがを みませんか？", romaji: "Issho ni eiga o mimasen ka?", meaning: "Won't you watch a movie together?" },
  { japanese: "がんばってください！", romaji: "Ganbatte kudasai!", meaning: "Please do your best!" }
];
