...
export const Phrasebook = () => {
  ...
  const defaultCategories = {
    'Greetings': [
      ...
      { jp: "おげんきですか？", ro: "O-genki desu ka?", en: "How are you?" },
    ],
    'Travel': [
      { jp: "えきは どこですか？", ro: "Eki wa doko desu ka?", en: "Where is the station?" },
      { jp: "きっぷを いちまい ください", ro: "Kippu o ichimai kudasai", en: "One ticket, please" },
      { jp: "いくらですか？", ro: "Ikura desu ka?", en: "How much is it?" },
      { jp: "たすけて ください", ro: "Tasukete kudasai", en: "Please help me" },
    ],
    'Food': [
      { jp: "メニューを ください", ro: "Menyuu o kudasai", en: "Menu, please" },
      { jp: "これを おねがいします", ro: "Kore o onegaishimasu", en: "This one, please" },
      { jp: "おかいけいを おねがいします", ro: "O-kaikei o onegaishimasu", en: "The bill, please" },
